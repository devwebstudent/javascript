function carregar() {
    ...
    if (hora >= 0 && hora < 12) {
        //BOM DIA
        mensagem.innerHTML = `Agora são ${hora} horas. <strong>Bom dia!</strong>`
        ...
        //BOA TARDE
        mensagem.innerHTML = `Agora são ${hora} horas. <strong>Boa tarde!</strong>`
        ...
        //BOA NOITE
        mensagem.innerHTML = `Agora são ${hora} horas. <strong>Boa noite!</strong>`
